 ...
 */
public class GenericFeatureSearcher extends AbstractFeatureSearcher {
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends GlobalFeature> globalFeature) {
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends LocalFeatureExtractor> localFeatureExtractor, Aggregator aggregator, int codebookSize, String codebooksDir) {
        this.maxHits = maxHits;
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends GlobalFeature> globalFeatureClass, SimpleExtractor.KeypointDetector detector, Aggregator aggregator, int codebookSize, String codebooksDir) {
        this.maxHits = maxHits;
        this.codebooksDir = codebooksDir;
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends GlobalFeature> globalFeature, boolean isCaching, IndexReader reader) {
        this.maxHits = maxHits;
        this.extractorItem = new ExtractorItem(globalFeature);
        this.fieldName = extractorItem.getFieldName();
        try {
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends LocalFeatureExtractor> localFeatureExtractor, Aggregator aggregator, int codebookSize, boolean isCaching, IndexReader reader, String codebooksDir) {
        this.maxHits = maxHits;
        this.codebooksDir = codebooksDir;
        this.extractorItem = new ExtractorItem(localFeatureExtractor);
        this.fieldName = extractorItem.getFieldName() + aggregator.getFieldName() + codebookSize;
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends GlobalFeature> globalFeatureClass, SimpleExtractor.KeypointDetector detector, Aggregator aggregator, int codebookSize, boolean isCaching, IndexReader reader, String codebooksDir) {
        this.maxHits = maxHits;
        this.codebooksDir = codebooksDir;
        this.extractorItem = new ExtractorItem(globalFeatureClass, detector);
        this.fieldName = extractorItem.getFieldName() + aggregator.getFieldName() + codebookSize;
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends GlobalFeature> globalFeature, boolean isCaching, IndexReader reader, boolean useSimilarityScore) {
        this.maxHits = maxHits;
        this.extractorItem = new ExtractorItem(globalFeature);
        this.fieldName = extractorItem.getFieldName();
        try {
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends LocalFeatureExtractor> localFeatureExtractor, Aggregator aggregator, int codebookSize, boolean isCaching, IndexReader reader, boolean useSimilarityScore, String codebooksDir) {
        this.maxHits = maxHits;
        this.codebooksDir = codebooksDir;
        this.extractorItem = new ExtractorItem(localFeatureExtractor);
        this.fieldName = extractorItem.getFieldName() + aggregator.getFieldName() + codebookSize;
    ...
    public GenericFeatureSearcher(int maxHits, Class<? extends GlobalFeature> globalFeatureClass, SimpleExtractor.KeypointDetector detector, Aggregator aggregator, int codebookSize, boolean isCaching, IndexReader reader, boolean useSimilarityScore, String codebooksDir) {
        this.maxHits = maxHits;
        this.codebooksDir = codebooksDir;
        this.extractorItem = new ExtractorItem(globalFeatureClass, detector);
        this.fieldName = extractorItem.getFieldName() + aggregator.getFieldName() + codebookSize;
...
//        }
    ...
    public FeatureSearchHits search(byte[] feature, IndexReader reader) throws IOException {
        ...
        if (extractorItem.isGlobal()){
            ...
            GlobalFeature globalFeature = (GlobalFeature) extractorItem.getExtractorInstance();
            globalFeature.setByteArrayRepresentation( feature);
