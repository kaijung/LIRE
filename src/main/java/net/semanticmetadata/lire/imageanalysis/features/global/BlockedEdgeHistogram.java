...
import net.semanticmetadata.lire.imageanalysis.features.global.mpeg7.BlockedEdgeHistogramImplementation;
 ...
 */
public class BlockedEdgeHistogram extends BlockedEdgeHistogramImplementation implements GlobalFeature {
    private int tmp;
    ...
    */
    ...
    public double[] getFeatureVector() {
        return ConversionUtils.toDouble(blockedEdgeHistogram);
    }

    @Override
    public String getFeatureName() {
        return "MPEG-7 Edge Blocked Histogram";
    }
