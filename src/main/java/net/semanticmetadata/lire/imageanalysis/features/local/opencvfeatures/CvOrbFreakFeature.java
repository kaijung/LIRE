 ...
 */
public class CvOrbFreakFeature implements Serializable, LocalFeature {
	// public float angle;
	// public int class_id;
	// public int octave;
	// public double[] point;
	...
	public CvOrbFreakFeature() {
	    }

	public CvOrbFreakFeature(double X, double Y, double size, double[] feature) {
	        this.X = X;
	        this.Y = Y;
	        this.size = size;
	...
	public double getDistance(LireFeature f) {
		if (!(f instanceof CvOrbFreakFeature))
			return -1;
		return MetricsUtils.distL2(feature, ((CvOrbFreakFeature) f).feature);
	}
	...
	public String getFieldName() {
		return DocumentBuilder.FIELD_NAME_CVORBFREAK;
	}
	...
	public Class<? extends LocalFeatureExtractor> getClassOfExtractor() {
		return CvOrbFreakExtractor.class;
	}
